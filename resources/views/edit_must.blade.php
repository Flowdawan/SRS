            ...
            <div class="container-lg">
                <div class="bg-transparent m-4 p-4">
                    <form action="{{ route('must.post') }}" method="POST">
                        ...
                        <p>The term MUST is used to define mandatory requirements. The defined requirement is mandatory.
                            The
                            fulfilling of the requirement in the product is mandatory. The acceptance of the product can
                            be
                            refused, if a MUST requirement has not been met.</p>

                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Must 1:</span>
                            </div>
                            <input value="{{ $project->must_1 ?? '' }}" type="text" name="must_1" class="form-control"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->must_2 ?? '' }}" type="text" name="must_2" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->must_3 ?? '' }}" type="text" name="must_3" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
