  ...
  <div class="container-lg">
    <div class="bg-transparent m-4 p-4">
      <form action="{{ route('editname.post') }}" method="POST">
        ...
        <p>Names have power. They indicate tone and the intent. They can, if chosen well, inspire and unify action. They’re an important part of a company’s brand and tone of voice. That’s why branding consultants are so highly paid, if not always highly valued.</p>

        <div class="form-floating">
            <textarea name="projectname" class="form-control" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
