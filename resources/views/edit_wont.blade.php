        ...
        @foreach($project as $project)
            ...
            <div class="container-lg">
                <div class="bg-transparent m-4 p-4">
                    <form action="{{ route('wont.post') }}" method="POST">
                        @csrf
                        <h1 class="display-3">Won't Requirements</h1>
                        <p>Won't requirements are also important to think about, just list what you absolutely do not
                            want
                            to be implementing in this project</p>

                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-default">Won't 1:</span>
                            </div>
                            <input value="{{ $project->wont_1 ?? '' }}" type="text" name="wont_1" class="form-control"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->wont_2 ?? '' }}" type="text" name="wont_2" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->wont_3 ?? '' }}" type="text" name="wont_3" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
