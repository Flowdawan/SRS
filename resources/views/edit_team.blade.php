                ...
                <div class="bg-transparent m-4 p-4">
                    <form action="{{ route('team.post') }}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->team_1 ?? '' }}" type="text" name="team_1" class="form-control"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->team_2 ?? '' }}" type="text" name="team_2" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input value="{{ $project->team_3 ?? '' }}" type="text" name="team_3" class="form-control"
                                   aria-label="Sizing example input"
                                   aria-describedby="inputGroup-sizing-default">
                        </div>
